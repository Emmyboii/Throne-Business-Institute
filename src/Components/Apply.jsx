                ...
                <form className="w-[90%] ms:w-[50%] mx-5 bg-white py-[35px] shadow-md shadow-black/50">
                    ...
                    <div className="ms:flex">
                        <div className="mx-5 ms:w-full">
                            ...
                            <input className='py-[12px] mt-2 w-full mb-3 pl-[20px] rounded-lg text-[18px] border-black border-2 outline-none' type="text" name="firstName" required placeholder='John' />
                        </div>
                        <div className="mx-5 ms:w-full">
                            <label className="text-[17px] sv:text-[20px] mo:text-[21px] font-semibold" htmlFor="lastNmae">LAST NAME</label><br />
                            <input className='py-[12px] mt-2 mb-3 pl-[20px] w-full rounded-lg text-[18px] border-black border-2 outline-none' type="text" name="lastName" required placeholder='Doe' />
                        </div>
                    </div>
                    <div className="ms:flex">
                        <div className="mx-5 ms:w-full">
                            ...
                            <input className='py-[12px] mt-2 mb-3 pl-[20px] w-full rounded-lg text-[18px] border-black border-2 outline-none' type="tel" name="phoneNo" required placeholder='09039926456' />

                        </div>
                        <div className="mx-5 ms:w-full">
                            <label className="text-[17px] sv:text-[19px] ms:text-[18px] mo:text-[21px] font-semibold" htmlFor="email">EMAIL ADDRESS</label><br />
                            <input className='py-[12px] mt-2 mb-3 pl-[20px] w-full rounded-lg text-[18px] border-black border-2 outline-none' type="email" name="emailAdd" required placeholder='johndoe@email.com' />
                        </div>
                    </div>
                    <div className="mx-5">
                        <label className="text-[17px] sv:text-[19px] mo:text-[21px] font-semibold" htmlFor="educationLvl">HIGHEST EDUCATION LEVEL</label><br />
                        <select className='py-[12px] mt-2 mb-3 pl-[20px] w-full text-[18px] rounded-lg border-black border-2 outline-none' name="educationLvl" required placeholder='Your First name here' >
                            <option value=""></option>
                    ...
                    <div className="mx-5">
                        ...
                        <select className='py-[12px] mt-2 mb-3 pl-[20px] text-[18px] w-full rounded-lg border-black border-2 outline-none' name="educationLvl" required placeholder='Your First name here' >
                    ...
                    <div className="mx-5">
                        <button type="submit" className='py-[15px] w-[100%] mt-1 rounded-xl font-semibold sw:text-[24px] bg-black text-white'>Register Now</button>
                    </div>
                </form>
            </div>
        </div>
