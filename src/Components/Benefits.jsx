        ...
        <div className='bg-pink-50 w-full py-[90px]'>
            <div className='ss:grid ss:grid-cols-2 px-7'>
                ...
                <div className='flex flex-col se:pl-[50px] st:pl-[px]'>
                    ...
                    <p data-aos="zoom-in-up" data-aos-delay="200" className='aos-init pl-[49px] md:text-[17px] ss:text-[16px] se:mt-0 st:mt-[-9px] se:text-[19px]'>We know how busy you are and we would not want to add to it, this is why our programs are made
                        at your own speed not ours
                    </p>
                    <br />
                    <div data-aos="zoom-in-up" data-aos-delay="200" className='aos-init flex mr:pt-4 sm:pt-1 items-center'>
                    ...
                    <p data-aos="zoom-in-up" data-aos-delay="200" className='aos-init pl-[49px] md:text-[17px] ss:text-[16px] se:mt-0 st:mt-[-9px] se:text-[19px]'>All programs are incorporated on an online platform which means you get to learn from the comfort of your
                    ...
                    <p data-aos="zoom-in-up" data-aos-delay="200" className='aos-init pl-[49px] md:text-[17px] ss:text-[16px] se:mt-0 st:mt-[-9px] se:text-[19px]'>With professionals on board, we take pride in making our students finish early so that they can move on to becoming better
                    </p>
                    <br />
                </div>
            </div>
